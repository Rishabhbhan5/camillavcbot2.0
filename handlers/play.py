...
async def play(_, message: Message):
    ...
    try:
        ...
        await lel.edit(
            f"<i>Hey {user.first_name}, @JennieKimMusicBot assistant userbot is not in this chat, ask admin to send /play command for first time to add it.</i>")
        return
            ...
            [
                [
                    InlineKeyboardButton(
                        text="Channel 🔊",
                        url="https://t.me/RishabhHelpGroup")
